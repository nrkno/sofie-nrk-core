...
interface IProps {
	onSetNext: (partInstance: DBPart | undefined, e: any, offset?: number, take?: boolean) => void
...
export function SegmentContextMenu({
	...
	const onSetAsNextFromHere = (
		...
		onSetNext(partInstance.part, e, offset || 0, take)
	}
					...
					timecode !== null && (
						<>
							...
							{startsAt !== undefined && part && enablePlayFromAnywhere ? (
								<>
									<MenuItem
										onClick={(e) => onSetAsNextFromHere(part.instance, e)}
									...
									<MenuItem
										onClick={(e) => onSetAsNextFromHere(part.instance, e, true)}
