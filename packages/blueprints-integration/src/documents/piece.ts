...
export interface IBlueprintPiece<TPrivateData = unknown, TPublicData = unknown> extends IBlueprintPieceGeneric<
	TPrivateData,
	TPublicData
> {
...
export interface IBlueprintPieceDB<TPrivateData = unknown, TPublicData = unknown> extends IBlueprintPiece<
	TPrivateData,
	TPublicData
> {
	_id: string
